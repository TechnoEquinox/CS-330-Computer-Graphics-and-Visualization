 ...
 *
 *  This method is automatically called from GLFW when
 *  the mouse scroll wheel is moved in either direction.
 ***********************************************************/
void ViewManager::Mouse_Scroll_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	if (g_pCamera)
	{
		...
		// Clamp the speed to prevent going too fast
		g_pCamera->MovementSpeed = glm::clamp(g_pCamera->MovementSpeed, 1.0f, 80.0f);
	}
}
...
void ViewManager::PrepareSceneView()
{
	...
	// switch between the orthographic projection and the perspective projection
	if (bOrthographicProjection)
	{
		...
		// Set the camera position so it is looking directly at the object
		g_pCamera->Position = glm::vec3(0.0f, 5.0f, 12.0f);
